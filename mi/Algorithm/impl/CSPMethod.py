...
class CSPMethod:
    ...
    def _band_fileter(self, data, flow=0.5, fhigh=40, time_window=4):      #flow:带通滤波器的下限频率
    ...
    def _predict(self, data, fm1, fm2, fm3, lda1, lda2, lda3):     #fm：特征提取器；lad：线性判别分析；val：值
